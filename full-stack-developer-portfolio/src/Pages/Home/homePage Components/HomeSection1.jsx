...
import kali from "/src/assets/kali.png";
import postmanLogo from "/src/assets/post.png";
      ...
      <div className="h-screen snap-start flex justify-center items-center relative">
        ...
        >
          ...
          <div className="col-span-1 md:col-span-4 flex flex-col justify-center gap-5 items-center relative">
            <motion.img src={terraform} alt="png3" className="absolute top-36 left-0  h-[25px] bounce" />
            <motion.img src={kali} alt="png3" className="absolute top-52 left-[250px] h-[50px] bounce" />
            ...
            <motion.img src={jenkins} alt="png3" className="absolute bottom-28 left-[200px] h-[40px] bounce" />
            <motion.img src={kubernetes} alt="png3" className="absolute bottom-44 left-[360px] h-[60px] bounce" />
            ...
            <div className="text-xs text-center text-blue-900 px-5 md:p-0">
              <p className="text-[16px] pb-2 font-semibold">
                Hello I&apos;m Vikas Gupta, A Experienced DevOps From India.
                <br />
              </p>
              Experienced in microservices architecture, CI/CD pipeline implementation, and cloud deployments using modern DevOps practices.
            </div>
            <Link to="/contact">
              <button
          ...
          <div className="col-span-1 md:col-span-4  h-screen w-full border-blue-900 border-double  hidden md:block ">
            <div className="h-full flex justify-end items-center me-20 ">
              <ul className="">
                ...
                <li className="text-lg my-10 p-5 border-4 border-blue-300 bg-white shadow-md rounded-full cursor-pointer hover:scale-110">
                  <Link target="_blank" to="mailto:vguptq08@gmail.com" className="text-red-600">
                    <SiGmail className="text-5xl" />
                  </Link>
                </li>
              </ul>
            </div>
            <motion.img src={AwsLogo} alt="png3" className="absolute top-36 left-[250px]  h-[40px] bounce" />
            <motion.img src={ansible} alt="png3" className="absolute  top-36 right-[370px] h-[60px] bounce" />
            <motion.img src={postmanLogo} alt="png3" className="absolute bottom-20 left-[300px]  h-[60px] bounce" />
            <motion.img src={chef} alt="png3" className="absolute bottom-24 right-[400px]  h-[20px] bounce" />
          </div>
        </div>
