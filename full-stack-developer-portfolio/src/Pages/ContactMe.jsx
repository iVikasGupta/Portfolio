              ...
              <div className="px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap h-full">
                <div className="lg:w-2/3 md:w-1/2 bg-transparent border-4 border-blue-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                  <iframe
                    ...
                    title="map"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1793.2625313565163!2d79.44884207387533!3d25.98361218874006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399d7edfbca84771%3A0x9e11b4c60c635959!2sNiyamatpur%2C%20Orai%2C%20Uttar%20Pradesh%20285001!5e0!3m2!1sen!2sin!4v1753854539821!5m2!1sen!2sin"
                  />
                  <div className="bg-white/80 relative flex flex-wrap py-6 border-4 text-blue-900 border-blue-300 rounded-md shadow-md">
                    <div className="lg:w-1/2 px-6">
                      ...
                      <p className="mt-1">Gopal Ganj Bambi Road Orai ( Jalaun) Uttar Pradesh , India</p>
                    </div>
                    <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                      <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                      <a className="text-blue-900 leading-relaxed">vguptaq08@gmail.com</a>
