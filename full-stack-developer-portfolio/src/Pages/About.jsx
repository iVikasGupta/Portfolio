...
const About = () => {
  return (
    <>
      <section className="relative h-screen  scroll-smooth overflow-x-hidden bg-white hide-scrollbar w-screen">
        <Navbar />
        <SubNavbar />
        <div
          className="  text-blue-900 sm:h-screen flex justify-center items-center overflow-y-auto"
          style={{
              ...
              <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                <div className="col-span-4 sm:col-span-3">
                  <div className=" border-4 border-blue-300 shadow rounded-lg p-6 h-full">
                    <div className="flex flex-col items-center">
                      <img src={profile} className="w-24 h-24 sm:w-28 sm:h-28 bg-gray-300 border-4 border-yellow-300 rounded-full mb-4 shrink-0" />
                      ...
                      <p className="text-blue-500">Devops Engineer</p>
                    ...
                    <hr className="my-0 sm:my-3 border-t border-blue-700" />
                    <div className="flex flex-col">
                      <ul className=" p-4 rounded-lg">
                        <li className="mb-2 flex justify-center items-center gap-2">
                          <h2 className="font-bold text-yellow-500 font-sans">AWS </h2>
                        ...
                        <li className="mb-2 flex justify-center items-center gap-2">
                          <h2 className="font-bold text-green-700 font-sans">Terraform </h2>
                        ...
                        <li className="mb-2 flex justify-center items-center gap-2">
                          <h2 className="font-bold text-black font-sans">Git & Github</h2>
                        ...
                        <li className="mb-2 flex justify-center items-center gap-2">
                          <h2 className="font-bold text-blue-500 font-sans">Jenkins</h2>
                        ...
                        <li className="mb-2 flex justify-center items-center gap-2">
                          <h2 className="font-bold text-blue-500 font-sans">Ansible</h2>
                        ...
                        <li className="mb-2 flex justify-center items-center gap-2">
                          <h2 className="font-bold text-green-700 font-sans">Linux </h2>
                        ...
                        <li className="mb-2 flex justify-center items-center gap-2">
                          <h2 className="font-bold text-slate-700 font-sans">Kubernetes </h2>
                ...
                <div className="col-span-4 sm:col-span-9">
                  <div className="border-4 border-blue-300 shadow rounded-lg p-6 h-full">
                    ...
                    <p className="text-gray-700 text-sm" style={{ fontFamily: `Winky Sans, sans-serif` }}>
                      I'm a DevOps Engineer with strong skills in cloud infrastructure (AWS), CI/CD pipelines, containerization (Docker), and automation.
                      Experienced in deploying and managing scalable applications on AWS EC2, implementing monitoring tools, and optimizing release cycles using
                      GitHub Actions. Skilled in working with Linux environments, scripting, and managing databases like MongoDB, MySQL, and PostgreSQL.
                      Passionate about building secure, high-availability systems and streamlining DevOps workflows for faster and more reliable software
                      delivery.
                    </p>
                    ...
                    <div className="mb-6">
                      <div className="flex justify-between flex-wrap gap-2 w-full">
                        <span className="text-blue-600 font-bold">DevOps Engineer</span>
                        <p>
                    ...
                    <div className="mb-6">
                      <div className="flex justify-between flex-wrap gap-2 w-full">
                        <span className="text-blue-600 font-bold">Java Developer Trainee</span>
                        <p>
                    ...
                    <div className="mb-6">
                      ...
                      <p className="mt-2 text-sm text-gray-500" style={{ fontFamily: `Winky Sans, sans-serif` }}>
                        ...
                        Website across all Devices. Learned about Domain registration, Domain Hosting Service
                      </p>
                    </div>
                  </div>
                </div>
