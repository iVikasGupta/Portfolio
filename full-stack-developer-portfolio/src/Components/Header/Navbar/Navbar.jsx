              ...
              <div className="grid grid-cols-1 md:grid-cols-12 place-content-center place-items-center">
                <div className="col-span-1 md:col-span-5 flex justify-center items-center p-16 md:h-screen md:p-0">
                  <div className="flex flex-col gap-5">
                    ...
                    <p className="text-cyan-500 px-5 md:px-0">+91 8887641882 / vguptq08@gmail.com</p>

                    <div className="flex justify-center items-center mt-5 gap-8 px-5 md:px-0">
                      <Link target="_blank" to="https://linkedin.com/in/abhishek-kank-ak47" className="text-cyan-500 hover:text-yellow-500">
                        <FaLinkedin className="sm:text-5xl text-3xl" />
                      </Link>

                      <Link target="_blank" to="https://github.com/abhishekkank47" className="text-cyan-500 hover:text-yellow-500">
                        <FaSquareGithub className="sm:text-5xl text-3xl" />
                      </Link>
                      <Link target="_blank" to="mailto:abhishekkank5@gmail.com" className="text-cyan-500 hover:text-yellow-500">
