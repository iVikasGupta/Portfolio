              ...
              <div className="px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap h-full">
                <div className="lg:w-2/3 md:w-1/2 bg-transparent border-4 border-blue-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                  <iframe
                    ...
                    title="map"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7013.436197176042!2d77.49192065011013!3d28.488035132667754!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cea69caa19b0f%3A0xabff93d72ae7c4f8!2sBlock%20C%2C%20Gamma%201%2C%20Greater%20Noida%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1767877631919!5m2!1sen!2sin"
                  />
                  <div className="bg-white/80 relative flex flex-wrap py-6 border-4 text-blue-900 border-blue-300 rounded-md shadow-md">
                    <div className="lg:w-1/2 px-6">
                      ...
                      <p className="mt-1">Gamma 1 Block C, Greater Noida, Uttar Pradesh, India</p>
                    </div>
                    <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                      <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                      <a className="text-blue-900 leading-relaxed">vikasgupta2426@gmail.com</a>
                      <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                      <p className="leading-relaxed">+91 8887641882</p>
                    </div>
                  </div>
                </div>
                <form
                ...
                >
                  <h2 className="text-blue-500 text-3xl font-bold mb-1 font-sans title-font text-center">Send A Message</h2>
