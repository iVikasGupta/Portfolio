                ...
                <div className="col-span-4 sm:col-span-9">
                  <div className="border-4 border-blue-300 shadow rounded-lg p-6 h-full">
                    ...
                    <p className="text-gray-700 text-sm" style={{ fontFamily: `Winky Sans, sans-serif` }}>
                      I'm a Full Stack Developer specializing in building high-performance, secure, and scalable web applications using the MERN stack. I
                      combine strong technical skills in Frontend Development, Backend Engineering, and Database Architecture with a DevOps mindset, ensuring
                      applications are both feature-rich and operationally resilient. Passionate about creating solutions that balance user experience with
                      technical excellence, I thrive on solving complex scalability challenges and implementing robust security measures
                    </p>
